...
class Scancode(enum.IntEnum):
    ...
    S_MEDIA_RECORD: typing.ClassVar[Scancode]  # value = <Scancode.S_MEDIA_RECORD: 264>
...
S_MEDIA_RECORD: Scancode  # value = <Scancode.S_MEDIA_RECORD: 264>
