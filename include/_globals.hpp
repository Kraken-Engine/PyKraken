...
enum class Keycode : SDL_Keycode
{
    ...
    K_SLEEP = SDLK_SLEEP,
    K_WAKE = SDLK_WAKE,
    K_CHANNEL_INC = SDLK_CHANNEL_INCREMENT,
    K_CHANNEL_DEC = SDLK_CHANNEL_DECREMENT,
    K_MEDIA_PLAY = SDLK_MEDIA_PLAY,
    K_MEDIA_PAUSE = SDLK_MEDIA_PAUSE,
    K_MEDIA_REC = SDLK_MEDIA_RECORD,
    K_MEDIA_FF = SDLK_MEDIA_FAST_FORWARD,
    K_MEDIA_REWIND = SDLK_MEDIA_REWIND,
    K_MEDIA_NEXT = SDLK_MEDIA_NEXT_TRACK,
    K_MEDIA_PREV = SDLK_MEDIA_PREVIOUS_TRACK,
