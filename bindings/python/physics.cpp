...
Args:
    ...
    nb::class_<Collision>(subPhysics, "Collision", nb::pooled(KRAKEN_PYTHON_POOL_CAPACITY), R"doc(
...
``enable_events`` set to True. Retrieve them with ``World.get_collisions()``.
    ...
    nb::class_<CastHit>(subPhysics, "CastHit", nb::pooled(KRAKEN_PYTHON_POOL_CAPACITY), R"doc(
